...
- **Video Optimizer**: Upload screen recordings, store in object storage, and automatically create optimized versions for every social platform using ffmpeg. Supports TikTok/Instagram Reels (9:16 1080x1920), Facebook Reels (9:16 1080x1920), Pinterest Pins (2:3 1000x1500), YouTube (16:9 1920x1080), and Square Posts (1:1 1080x1080). Auto-generates thumbnails, probes video dimensions. Includes post scheduler with platform selection, caption, hashtags, and scheduling. Uses `social_videos`, `social_video_variants`, and `social_posts` tables. Admin page at `/admin/video-optimizer`.
- **Tip of the Day**: AI-powered daily business tips using OpenAI gpt-4o-mini. 150+ categories covering domains, SSL, hosting, SEO, social media marketing, email marketing, content creation, AI tools, Git/GitHub, branding, e-commerce, and more. Tips written for non-technical small business owners with everyday analogies. Shareable tip pages with OG images, subscribe form, and social share buttons.
